...
- [ ] **Step 1: Add the exact tool dependency and licence inventory**
...
- [ ] **Step 2: Add the root configuration and workspace scripts**
...
- [ ] **Step 3: Establish the approved formatting baseline**
...
reformat Markdown or YAML. Before formatting, `git status --short` must be
empty; otherwise stop so unrelated changes cannot enter the baseline commit.

- [ ] **Step 4: Enforce the same read-only checks in CI**
...
- [ ] **Step 5: Verify the tool gate and unaffected compiler contract**
