...
export { lanAddress, listenWithFallback, openBrowser, waitUntilReachable } from './cli/net.js';
...
export type { DescribedSensor, ProviderFailure, SampleCycle } from './providers/registry.js';
