...
export function setObjectAssetReference(object: AssetObject, reference: FabricAssetReference): void {
  if (!isFabricAssetReference(reference)) throw new Error('Invalid Fabric asset reference.');
