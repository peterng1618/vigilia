...
function isSolid(value: unknown): value is { readonly kind: 'solid'; readonly color: string } {
  const color = typeof value === 'object' && value !== null ? (value as Record<string, unknown>)['color'] : undefined;
