...
| Shared line-chart motion | 950 units, seven typechecks, and player/editor builds passed on 2026-09-20; player/editor share `renderer-core` line geometry, live batches receive browser-local presentation timestamps on release, and line windows retain one left-edge predecessor. |
