...
- Fabric image/SVG references serialise and revive; the editor owns validated package bytes and revocable previews. Controls and package threading remain in progress.
