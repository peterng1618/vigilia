...
Current fork extensions are only charts, persistence and shortcuts. Startup still
builds the legacy demo theme into a `ScenePlan` rather than starting directly
from a v2 envelope.
